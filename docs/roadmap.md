...
- Deterministic unit conversion through the Rust core, generic dispatcher, CLI, schemas, examples, and MCP wrapper.
- Finance/business calculators for simple interest, compound interest, loan payment, VAT, percentage change, margin/markup, and exact-representable CAGR.
...
- TypeScript MCP wrapper for arithmetic, expression evaluation, unit conversion, finance, verification, and expected-value generation.
